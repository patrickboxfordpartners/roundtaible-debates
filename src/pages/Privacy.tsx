      ...
      <div className="mt-12 space-y-8 text-gray-700 leading-relaxed">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Account data</strong> — name, email address, and registration information collected during sign-up.</li>
            <li><strong>Debate and content data</strong> — debate topics, arguments, and interactions you create within the platform.</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>To provide, operate, and improve The Roundtaible platform</li>
            <li>To generate AI-powered debate content and responses</li>
